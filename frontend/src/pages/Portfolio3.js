        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-r from-gray-800 to-blue-600 rounded-lg p-3 w-[450px] h-[505px] ml-8">
                <img 
                  src={appMain} 
                  alt="Website Screenshot"
                  className="w-[450px] h-[480px] rounded-lg shadow-lg"
                />
              </div>
            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-sm text-gray-600 mb-1">3GMAP-MOB-2025</h2>
                <h1 className="text-2xl font-bold text-gray-900 mb-4">
                  Project Management App for Technician | 3G Digital Amritsar
                </h1>
...
{/* Client Story */}
        <div className="mb-8 p-3 bg-white rounded-lg border-l-4 border-blue-500">
            <h1 className='text-2xl font-semibold mb-4'>Manual to Digital</h1>
            <p className="text-lg text text-gray-700 mt-2 mb-1">Staff shifts from manual to app-based work.</p>
          <p className="text-lg italic text-gray-900">"Cheating came to an end, and customer trust returned. As work became transparent, the company started to grow. With assignments sent through the manager panel, every task left a report — accountability rose, lazy staff were revealed, and productivity improved"
        </p>
        ...
        {/* Website Highlights */}
          <div className="bg-gray-50 rounded-lg shadow-lg p-8 mb-8">
            <h3 className="text-2xl font-semibold text-gray-900 mb-6">App Highlights</h3>
            <div className="bg-gray-50 px-32 py-8">
            <div className="flex justify-center gap-6 bg-gray-200 py-8 rounded-2xl">
              <div className="text-center">
                <img 
                  src={app1} 
                  alt="Website Performance Analytics"
                  className="w-[200px] h-[385px] rounded-lg shadow mb-2 mt-4"
                />
              ...
              <div className="text-center">
                <img 
                  src={app4} 
                  alt="Website Performance Analytics"
                  className="w-[195px] h-[385px] rounded-lg shadow mb-2 mt-4"
                />
              ...
              {/* <div className="text-center">
                <img 
                  src={app1} 
                  alt="Website Performance Analytics"
                  className="w-62 h-96 rounded-lg shadow mb-2 mt-4"
                />
              </div> */}
       ...
       {/* Website Screenshots */}
          <div className="bg-gray-200 rounded-lg shadow-sm p-8 mb-8">
            <h3 className="text-2xl font-semibold text-gray-900 mb-6">Software Screenshots | Complaint Management System</h3>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mt-8">
          ...
          <p className="text-gray-600 mb-4">Current Version: 3GMAP-MOB-1709-2025 (Project Management App for Technician)</p>
