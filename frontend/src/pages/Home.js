...
import { ChevronRight, Users, Globe, Smartphone, Database, Code, UserCheck, Search, Settings, Star, Plus, MapPin, Phone, Mail, Shield, Clock, Award, ArrowRight, TrendingUp, Zap, X } from 'lucide-react';
...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-cyan-50 via-blue-50 to-indigo-100 pt-20 pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <h1 className="text-5xl lg:text-5xl font-bold text-gray-900 leading-tight capitalize">
                Want to grow your business
                <span className="block text-blue-600">with smart automation?</span>
              </h1>
              <p className="text-2xl text-gray-900 leading-relaxed max-w-xl">
                We develop websites and software according to your needs, with lifetime support to ensure you always stay updated.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <button 
                onClick={handleStartProjectClick}
                className="cta-button group/btn bg-gradient-to-br from-blue-500 to-blue-900 text-white px-8 py-4 rounded-lg hover:from-blue-600 hover:to-blue-900 font-semibold flex items-center justify-center transition-all transform hover:scale-105 shadow-md hover:shadow-lg">
                ...
                <button className="cta-button group/btn border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-lg font-semibold transition-all transform hover:scale-105 shadow-md hover:shadow-xl">
                   <span className="flex items-center">
                  View Portfolio
                  <span className="ml-1 opacity-0 group-hover/btn:opacity-100 transform translate-x-1 group-hover/btn:translate-x-0 transition-all duration-300">
                    →
...
<section id="portfolio" className="py-20 bg-gray-50 border-t border-gray-200">
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
      {[
        {
          ...
          type: "Website",
          blurb: "Shree Lakshami Narayan Aurvedic College Amritsar",
          image: sln1,
          href: "sln",
     ...
     <div className="text-center mt-12">
            <button className="bg-blue-600 text-white px-8 py-4 rounded-lg hover:bg-blue-700 font-semibold transition-all transform hover:scale-105">
...
<section className="py-20 bg-gray-50 border-t border-gray-200">
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="text-center mb-16">
      ...
      <h2 className="capitalize text-4xl font-bold text-indigo-600 leading-tight mb-3">
        Track Your Project Live,
        <span className=" text-gray-900"> from start to finish.</span>
      </h2>
    ...
    <div className="bg-gray-50 p-10 rounded-3xl shadow-xl max-w-6xl mx-auto border border-gray-100">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="group bg-white text-center p-6 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border border-blue-100 hover:border-blue-800 hover:-translate-y-1 cursor-pointer relative overflow-hidden">
          ...
          <div className="text-blue-800 font-medium group-hover:text-blue-600">Get Started</div>
        </div>
        ...
        <div className="group bg-white text-center p-6 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border border-purple-100 hover:border-purple-800 hover:-translate-y-1 cursor-pointer relative overflow-hidden">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-2">Cloud Software</h3>
          <p className="text-gray-600 mb-4">Custom business management systems</p>
          <div className="text-purple-800 font-medium group-hover:text-purple-600">Get Started</div>
        </div>
        ...
        <div className="group bg-white text-center p-6 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border border-indigo-100 hover:border-indigo-800 hover:-translate-y-1 cursor-pointer relative overflow-hidden">
          ...
          <div className="text-indigo-800 font-medium group-hover:text-indigo-600">Get Started</div>
        </div>
      </div>
    </div>
  </div>
