        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-br from-orange-400 to-blue-600 rounded-lg p-3">
                <img 
                  src={ezing1} 
...
{/* Client Story */}
        <div className="mb-8 p-3 bg-white rounded-lg border-l-4 border-blue-500">
            ...
            <p className="text-lg text text-gray-700 mt-2 mb-1">They gained local trust, but without online presence, even less experienced names moved ahead — so they decided to win trust online too.</p>
