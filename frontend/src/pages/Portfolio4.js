...
import ezing1 from '../assets/ezing1.jpg';
import ezing2 from '../assets/ezing2.jpg'
import ezing3 from '../assets/ezing3.jpg'
import ezing4 from '../assets/ezing4.jpg'
import ezing5 from '../assets/ezing5.jpg'
import ezing6 from '../assets/ezing6.jpg'
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-gray-900">Ezing Overseas</span>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-br from-gray-700 to-blue-600 rounded-lg p-3">
                <img 
                  src={ezing1} 
            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-sm text-gray-600 mb-1">EZDYN-DYNAMIC-2024</h2>
                <h1 className="text-2xl font-bold text-gray-900 mb-4">
                  Immigration Website | Ezing Overseas Amritsar
                </h1>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">https://www.ezingoverseas.com/</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">Dynamic Website</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">22-07-2024</p>
                  </div>
                </div>

                <div className="flex space-x-4 mr-8">
                    <Link to="https://www.ezingoverseas.com/">
...
{/* Client Story */}
        <div className="mb-8 p-3 bg-white rounded-lg border-l-4 border-blue-500">
            <h1 className='text-2xl font-semibold mb-2'>Importance of Digital Marketing in the Modern Era</h1>
            <p className="text-lg text text-gray-700 mt-2 mb-3">They gained local trust, but without online presence, even less experienced names moved ahead — so they decided to win trust online too.</p>
          <p className="text-lg italic text-gray-700">"Their presence was limited to Facebook and Instagram ads, which never gave real growth. When they approached us, we showed them the right path — a dynamic portfolio they could update anytime. This gave them visibility, credibility, and the digital trust they were missing."
        </p>
        ...
        {/* Website Highlights */}
         <div className="bg-gray-200 rounded-lg shadow-sm p-8 mb-8">
          <h3 className="text-lg font-semibold text-gray-900 mb-6">Website Highlights</h3>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="text-center">
              <img 
                src={ezing3} 
                alt="Website Performance Analytics"
                className="w-full h-full rounded-lg shadow mb-3"
              />
        ...
        {/* Website Screenshots */}
        <div className="bg-gray-200 rounded-lg shadow-sm p-8 mb-8">
          <h3 className="text-2xl font-semibold text-gray-900 mb-6">Website Screenshots</h3>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mt-8">
          ...
          <p className="text-gray-600 mb-4">Current Version: EZDYN-DYNAMIC-2024 (Dynamic Website with Admin Panel)</p>
          <div className="text-sm text-gray-500">
            Launch Date 22-07-2024 | Status: Offline
          </div>
        </div>
