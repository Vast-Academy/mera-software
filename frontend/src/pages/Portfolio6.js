...
import va4 from '../assets/va4.jpg'
import va5 from '../assets/va5.jpg'
import va6 from '../assets/va6.jpg'
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-gray-900">VA Computers</span>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-br from-red-400 to-blue-600 rounded-lg p-3">
                <img 
                  src={va1} 
            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-sm text-gray-600 mb-1">VACOMP-DYNAMIC-2024</h2>
                <h1 className="text-2xl font-bold text-gray-900 mb-4">
                  Portfolio Website | VA Computers Amritsar
                </h1>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">https://www.vacomputers.com/</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium">15-09-2023</p>
                  </div>
                </div>

                <div className="flex space-x-4 mr-8">
                    <Link to="https://www.vacomputers.com/">
...
{/* Client Story */}
        <div className="mb-8 p-3 bg-white rounded-lg border-l-4 border-blue-500">
            <h1 className='text-2xl font-semibold mb-4'>Beyond Social Media and WordPress</h1>
            <p className="text-lg text text-gray-700 mt-2 mb-1">They knew ads and basic websites weren’t enough — they needed something stronger to grow.</p>
          <p className="text-md italic text-gray-700">"At first, their work was limited to social media marketing and WordPress websites with very few features. But after partnering with us, they finally discovered the power of coding-based solutions — websites with unlimited functionality, scalability, and reliability that helped them deliver real value to their clients."
        </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="text-center">
              <img 
                ...
                className="w-full full rounded-lg shadow mb-3"
              />
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mt-8">
          ...
          <p className="text-gray-600 mb-4">Current Version: VACOMP-DYNAMIC-2024 (Dynamic Website with Admin Panel)</p>
          <div className="text-sm text-gray-500">
            Last Updated on 11-11-2024 | Status: Live & Operational
          </div>
        </div>
